<div class="d-flex align-items-center justify-content-center bg-sl-primary ht-md-100v">
    <div class="login-wrapper wd-300 wd-xs-400 pd-25 pd-xs-40 bg-white">
        ...
        <div class="form-group">
            ...
            <a href="{{ url('/admin/sendOtp') }}" class="tx-info tx-12 d-block mg-t-10">Forgot password?</a>
        </div>

        <button onclick="SubmitLogin()" class="btn btn-info btn-block">Sign In</button>
        <div class="mg-t-40 tx-center">Have not an account? <a href="{{ route('admin.registration.page')}}" class="tx-info">Sign Up</a></div>
    </div>
</div>
