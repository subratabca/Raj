...
<script>
    ...
    async function profileInfo() {
        try {
            const response = await axios.get('/admin/profile/info');
            ...
            if (response.status === 200) {
                ...
                document.getElementById('admin-header-img').src = userData['image'] ? "/upload/admin-profile/small/" + userData['image'] : "/upload/no_image.jpg";
            ...
            unreadNotifications.forEach(notification => {
                notificationsHTML += `
                    <div class="notification-item">
                        <a href="/admin/markAsRead/notification/${notification.id}" class="media-list-link">
    ...
    async function deleteNotification(notificationId) {
        try {
            const response = await axios.get(`/admin/delete/notification/${notificationId}`);
