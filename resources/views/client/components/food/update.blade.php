            ...
            <div class="col-lg-12">
              <div class="row">
                ...
                <div class="col-lg-8">
                  <div class="row">
                    <div class="col-lg-6">
                      <label class="form-control-label">Upload New Food Image: <span class="tx-danger">*</span></label>
...
<script>
   async function FillUpUpdateForm(id,filePath){
      ...
      try {
          ...
          document.getElementById('update_expire_date').value = res.data.data['expire_date'];
          document.getElementById('update_address').value = res.data.data['address'];
          document.getElementById('update_collection_date').value = res.data.data['collection_date'];
          document.getElementById('update_start_collection_time').value = res.data.data['start_collection_time'];
          document.getElementById('update_end_collection_time').value = res.data.data['end_collection_time'];
          $('#update_description').summernote('code', res.data.data['description']);
  ...
  async function updateFood() {
    ...
    if (update_name.length === 0) {
      ...
      try {
          let res = await axios.post("/client/update",formData,config)
          if (res.status === 200) {
